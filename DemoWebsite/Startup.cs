...
namespace LibraOCR.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger Librasoft OCR", Version = "v1" });
            ...
            services.AddTransient<IAdministrativeDocumentsService, AdministrativeDocumentsService>();
